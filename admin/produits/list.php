            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <h1 class="text mt-5">List Of Products</h1> 
                        ...
                        <div class="table">
                                ...
                                <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            //     <td >'.$p['nom'].'</td>
                                            //     <td >'.$p['description'].'</td>
                                            //     <td> <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editModal'.$p['id'].'" >Update</a>
                                            //      <a href="supprimer.php?idc='.$p['id'].'" class="btn btn-danger">Delete</a> </td>
                                            // </tr>';
                                            // }
                                            ?>
                        ...
                        <div class="modal-body">
                            <form action="ajout.php" method="post" id="addForm">
                                <div class="form-group">
                                    <input name="nom" type="text" class="form-control" placeholder="product name...">
                                </div>
                                <div class="form-group">
                                    <input name="prix" step="0.01" type="number" class="form-control" placeholder="product price...">
                                </div>
                                <div class="form-group">
                                    <textarea name="description"  class="form-control" placeholder="product description ..."></textarea>
                                </div>
                                <div class="form-group">
                                    <input name="image" type="file" class="form-control" placeholder="product image...">
                                </div>
                        </div>
